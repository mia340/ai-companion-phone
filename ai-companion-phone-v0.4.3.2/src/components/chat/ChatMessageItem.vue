...
.role-card-ui{width:min(100%,430px);box-sizing:border-box;margin-bottom:5px;padding:10px 12px;border:1px solid rgba(197,101,141,.16);border-radius:14px;background:linear-gradient(145deg,rgba(255,255,255,.92),rgba(255,241,247,.9));color:#6f5360;box-shadow:0 3px 12px rgba(82,49,63,.05)}.role-card-ui__top{display:flex;align-items:center;justify-content:space-between;gap:12px;padding-bottom:6px;border-bottom:1px solid rgba(184,121,148,.12)}.role-card-ui__top b{color:#b1587e;font-size:11px}.role-card-ui__top span{color:#9b7b88;font-size:10px}.role-card-ui__row{display:grid;grid-template-columns:32px minmax(0,1fr);gap:7px;padding-top:6px;font-size:11px;line-height:1.45}.role-card-ui__row small,.role-card-ui__todos>small{color:#b47a92;font-size:9px}.role-card-ui__todos{display:grid;grid-template-columns:32px minmax(0,1fr);gap:7px;padding-top:6px}.role-card-ui--standalone{flex:0 0 min(84%,430px);margin-left:47px}.message-row--action .role-card-ui--standalone{margin-left:0}.role-card-ui__todos ol{margin:0;padding-left:17px;color:#715866;font-size:10px;line-height:1.5}
...
.message-delivery-state{align-self:flex-end;margin:0 4px 2px 0;padding:3px 4px;border:0;background:transparent;color:#9b7d89;font-size:10px;white-space:nowrap}.message-delivery-state--failed,.message-delivery-state--cancelled,.message-delivery-state--vision-fallback{color:#c84f63;font-weight:700}
