...
<style scoped>
.persona-page{min-height:100%;padding:14px;background:#f7f0f3;color:#5d4350}.intro-card,.editor-card,.persona-card,.preview-card{border:1px solid rgba(109,70,87,.08);border-radius:20px;background:#fff;box-shadow:0 8px 28px rgba(79,46,61,.06)}.intro-card{padding:16px;margin-bottom:12px}.intro-card p{margin:6px 0;color:#947482;line-height:1.6;font-size:13px}.intro-card small{display:block;margin-top:9px;color:#a28491;line-height:1.5}.import-actions{margin-top:12px}.hidden-file{position:absolute!important;width:1px!important;height:1px!important;opacity:0!important;pointer-events:none}.editor-card{display:grid;gap:12px;padding:16px}.section-title,.preview-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.section-title h2,.preview-head h2{margin:0;font-size:18px}.section-title button,.card-actions button,.preview-head button,.preview-actions button{border:0;background:#f5e9ee;color:#9b6078;border-radius:10px;padding:7px 10px}.editor-card label,.advanced-fields label{display:grid;gap:6px;font-size:13px;font-weight:700}.editor-card input,.editor-card textarea{width:100%;box-sizing:border-box;border:1px solid #eadce2;border-radius:12px;background:#fffbfc;padding:10px 12px;color:#593f4b;font:inherit;resize:vertical}.two-fields{display:grid;grid-template-columns:1fr 150px;gap:10px}.persona-avatar-editor__row{display:flex;align-items:center;gap:8px}.persona-avatar-editor__row input{min-width:0}.persona-avatar-editor__image-label{flex:1;color:#9b7a88;font-size:11px}.avatar-file-button{display:block!important;padding:8px 9px;border-radius:10px;background:#f7ebf0;color:#a05c78;text-align:center;cursor:pointer}.avatar-clear-button{padding:6px 8px;border:0;border-radius:9px;background:#fff0f3;color:#b75570;font-size:11px}.three-fields{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.default-switch{display:flex!important;grid-template-columns:auto 1fr;align-items:center}.default-switch input{width:auto}.primary{border:0;border-radius:14px;background:#dc76a0!important;color:#fff!important;padding:12px;font-weight:800}.compact{padding:9px 12px!important}.message{padding:10px 12px;border-radius:12px;background:#fff5f8;color:#b65178}.truth-tip{margin:0;padding:10px 12px;border-radius:12px;background:#fff5f8;color:#9a657b;font-size:12px;line-height:1.55}.advanced-fields{border:1px solid #f0e1e7;border-radius:14px;padding:10px 12px}.advanced-fields summary{cursor:pointer;font-weight:800;color:#9a6077}.advanced-fields[open]{display:grid;gap:10px}.advanced-fields[open] summary{margin-bottom:4px}.persona-list{display:grid;gap:10px;margin-top:14px;padding-bottom:30px}.persona-card{display:grid;grid-template-columns:48px minmax(0,1fr);gap:10px;padding:14px}.persona-avatar{display:grid;place-items:center;width:48px;height:48px}.persona-copy{min-width:0}.persona-copy>div{display:flex;align-items:center;gap:7px}.persona-copy span{border-radius:999px;background:#f1d2df;color:#b14f78;padding:2px 7px;font-size:10px}.persona-copy small{color:#9a7a88}.persona-copy p{margin:7px 0;color:#755965;line-height:1.5;font-size:12px;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}.card-actions{grid-column:1/-1;display:flex;justify-content:flex-end;gap:7px;flex-wrap:wrap}.card-actions .danger{color:#b64c63}.preview-card{padding:16px;margin-bottom:12px}.preview-head small{color:#a1818f}.preview-head button{border-radius:50%;width:34px;height:34px;font-size:20px}.detect-row{display:flex;align-items:center;justify-content:space-between;margin:12px 0;padding:10px 12px;border-radius:12px;background:#fff5f8}.detect-row span{font-size:11px;color:#a66c83}.preview-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.preview-grid>div{display:grid;gap:3px;padding:11px;border-radius:12px;background:#faf4f6}.preview-grid small{color:#9b7b88}.preview-grid b{font-size:20px;color:#c45d88}.preview-card p{font-size:12px;line-height:1.55;white-space:pre-wrap}.preview-card .note{color:#a1677e}.preview-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}@media(max-width:390px){.two-fields,.three-fields{grid-template-columns:1fr}.card-actions{justify-content:flex-start}}
</style>
