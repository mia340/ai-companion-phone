...
<style scoped>
.memory-page{min-height:100%;padding:14px 14px 40px;background:#f2f8fc;color:#40566a}.notice{position:sticky;top:6px;z-index:3;margin:0 0 10px;padding:9px 12px;border-radius:12px;background:#744f60;color:#fff;text-align:center}.hero,.add-card,.history-card{margin-bottom:12px;padding:15px;border:1px solid rgba(92,58,73,.08);border-radius:20px;background:#fff}.hero small{color:#a17c8d}.hero h2{margin:4px 0 8px}.hero p{margin:0;color:#748b9e;font-size:12px;line-height:1.7}.summary-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin-bottom:12px}.summary-grid article{display:grid;gap:3px;padding:13px;border-radius:16px;background:#fff}.summary-grid b{color:#6d9fc8;font-size:22px}.summary-grid small{color:#748b9e}.add-card{display:grid;gap:10px}.add-card label{display:flex;align-items:center;justify-content:space-between;gap:12px}.add-card select,.add-card textarea{border:1px solid #d7e5f0;border-radius:12px;background:#fff;padding:10px;color:inherit}.add-card textarea{width:100%;resize:vertical}.add-card button{border:0;border-radius:13px;background:#79add8;color:#fff;padding:11px;font-weight:800}.filters{display:flex;gap:6px;overflow-x:auto;margin:0 -14px 12px;padding:0 14px 4px;scrollbar-width:none}.filters button{flex:0 0 auto;border:0;border-radius:999px;background:#fff;color:#6d8498;padding:8px 11px}.filters button.active{background:#79add8;color:#fff}.memory-list{display:grid;gap:10px}.memory-card{padding:13px;border:1px solid rgba(95,60,75,.08);border-radius:18px;background:#fff}.memory-card.status-conflict{border-color:#e4a451;background:#fffaf1}.memory-card.status-invalid{opacity:.68;background:#f4eff1}.memory-meta{display:flex;flex-wrap:wrap;gap:5px}.memory-meta span{border-radius:999px;background:#eaf3fa;color:#6f94b2;padding:4px 7px;font-size:10px}.memory-card p{margin:10px 0 7px;line-height:1.65}.memory-card>small{display:block;margin-top:3px;color:#9a7b88}.conflict-box{margin-top:9px;padding:9px 10px;border-radius:12px;background:#fff3df;color:#8d6743}.conflict-box b{font-size:11px}.conflict-box p{margin:4px 0 0;font-size:12px;line-height:1.45}.actions{display:flex;flex-wrap:wrap;gap:6px;margin-top:11px}.actions button{border:0;border-radius:10px;background:#e8f2f9;color:#5f7f99;padding:7px 9px}.actions button:disabled{opacity:.35}.actions .resolve{background:#e8f3eb;color:#44755a}.actions .danger{background:#fff0f2;color:#b34f69}.history-card summary{cursor:pointer;font-weight:800}.history-card article{margin-top:9px;padding:10px;border-radius:12px;background:#f2f8fc}.history-card p{margin:4px 0}.history-card small{color:#73889c}.empty{padding:24px;color:#9a7d8a;text-align:center}
</style>
