...
.composer-area{flex:0 0 auto;display:flex;flex-direction:column;gap:8px;padding:9px;border:1px solid rgba(52,82,104,.08);border-radius:17px;background:rgba(255,255,255,.94);box-shadow:0 7px 20px rgba(45,77,101,.06);backdrop-filter:blur(12px)}.ask-composer{display:flex;align-items:flex-end;gap:7px}.ask-input,.guess-input{width:100%;min-height:40px;padding:9px 11px;border:0;border-radius:12px;outline:none;background:#f7fafc;color:#293d4d;font-size:13.5px;line-height:1.5;resize:none}.ask-input:focus,.guess-input:focus{background:#fff;box-shadow:0 0 0 3px rgba(95,159,210,.09)}.send-btn{min-width:50px;height:38px;padding:0 12px}.guess-composer{display:grid;gap:7px}.guess-actions{display:flex;justify-content:flex-end;gap:7px}.tool-row{display:flex;gap:6px}.tool-btn{flex:1;min-width:0;padding:8px 5px;border:0;border-radius:10px;background:#f3f6f8;color:#637888;font-size:11.5px;cursor:pointer}.tool-btn.ghost{background:transparent;color:#8b99a4}.tool-btn:disabled{opacity:.42}
