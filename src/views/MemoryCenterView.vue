    ...
    <main class="memory-center">
      <section class="overview">
        ...
        <div class="overview-actions">
          <button type="button" @click="router.push('/app/时光')">时光</button>
