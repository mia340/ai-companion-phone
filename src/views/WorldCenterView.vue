...
<style scoped>
.world-center{min-height:100%;padding:14px 14px 40px;background:#f4f8fb;color:#344f64}.hero-card{display:flex;gap:14px;align-items:center;padding:18px;border-radius:24px;background:#fff;border:1px solid rgba(45,67,85,.07);box-shadow:0 4px 16px rgba(45,76,103,.035)}.hero-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:18px;background:#e7f2fa;font-size:29px}.hero-card small{color:#5f8fb2;font-weight:800;letter-spacing:.08em}.hero-card h1{margin:2px 0 4px;font-size:22px}.hero-card p,.section-head p,.apply-card span{margin:0;color:#73889c;font-size:12px;line-height:1.6}.tabs{display:grid;grid-template-columns:repeat(5,1fr);gap:4px;margin:12px 0;padding:4px;border-radius:16px;background:#e8f0f5}.tabs button{border:0;border-radius:12px;background:transparent;padding:9px 2px;color:#73889c;font-size:11px}.tabs button.active{background:#fff;color:#34536a;font-weight:800;box-shadow:0 2px 8px rgba(45,76,103,.06)}.apply-card,.import-card,.compat-card,.report-card{padding:14px;border-radius:18px;background:#fff;margin-bottom:12px}.scope-switch{display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-bottom:10px;padding:4px;border-radius:13px;background:#e8f1f6}.scope-switch button{border:0;border-radius:10px;background:transparent;padding:8px;color:#748b9e}.scope-switch button.active{background:#fff;color:#5688ad;font-weight:800}.global-chip{padding:10px 11px;border-radius:12px;background:#eef6fb;color:#678397;font-size:11px;line-height:1.55}.apply-card label{display:grid;gap:6px;font-size:12px;font-weight:800}.apply-card select{border:1px solid #dce8ef;border-radius:12px;background:#fbfdff;padding:10px;color:#34536a}.character-chip{display:flex;align-items:center;gap:8px;margin-top:10px}.notice{padding:10px 12px;border-radius:12px;background:#eef6fb;color:#5f7f97;font-size:12px}.resource-list{display:grid;gap:10px}.section-head{display:flex;justify-content:space-between;align-items:flex-start;gap:10px;padding:8px 2px}.section-head h2{margin:0 0 3px;font-size:18px}.section-head button,.resource-actions button,.legacy button{border:0;border-radius:10px;background:#e8f2f9;color:#5688ad;padding:8px 10px}.resource-card,.state-card{padding:14px;border:1px solid rgba(45,67,85,.07);border-radius:18px;background:#fff;box-shadow:0 4px 14px rgba(45,76,103,.03)}.resource-main{display:flex;gap:10px}.resource-icon{width:40px;height:40px;display:grid;place-items:center;flex:0 0 auto;border-radius:12px;background:#e8f3fa;font-size:20px}.resource-main b,.resource-main small{display:block}.resource-main small{margin-top:3px;color:#7d91a3;font-size:10px}.resource-main p{margin:7px 0 0;color:#657f91;font-size:12px;overflow-wrap:anywhere;word-break:break-word}.usage-line{display:block;margin-top:7px;color:#5f8fb2;font-size:10px;line-height:1.5}.resource-main code{display:block;margin-top:7px;max-width:300px;overflow:hidden;color:#6f8494;font-size:10px;white-space:nowrap}.resource-actions{display:flex;align-items:center;justify-content:flex-end;gap:7px;margin-top:11px}.toggle{display:flex;align-items:center;gap:5px;color:#5f829d;font-size:11px}.toggle input{accent-color:#6daedc}.fixed-tag{padding:5px 8px;border-radius:999px;background:#eaf3fa;color:#a96882;font-size:10px}.danger{color:#b54f65!important}.legacy{display:flex;align-items:center;justify-content:space-between}.legacy small{display:block;color:#9e7d8b}.state-title{display:flex;align-items:center;gap:8px}.presence{margin-left:auto;padding:4px 8px;border-radius:999px;background:#eee;color:#856b76;font-size:10px}.presence.together{background:#fbe3ed;color:#b24e78}.state-card dl{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:12px 0 0}.state-card dl div{padding:9px;border-radius:11px;background:#fbf6f8}.state-card dt{color:#a17f8d;font-size:9px}.state-card dd{margin:3px 0 0;font-size:12px}.library{display:grid;gap:12px}.import-card{text-align:center;padding:24px 18px}.import-icon{font-size:40px}.import-card h2{margin:8px 0}.import-card p{color:#977482;line-height:1.6;font-size:12px}.import-card button{width:100%;border:0;border-radius:14px;background:#6daedc;color:#fff;padding:12px;font-weight:800}.report-card h3,.compat-card h3{margin:0 0 8px}.report-card p,.report-ok,.report-warning,.compat-card p,.compat-card li{font-size:11px;line-height:1.6}.report-ok{color:#557a65}.report-warning{margin-top:6px;color:#aa6b40}.compat-card ul{margin:8px 0 0;padding-left:18px}.empty{text-align:center;padding:30px 10px;color:#a88996;font-size:12px}.archive-section{display:grid;gap:10px}.archive-count{min-width:28px;height:28px;display:grid;place-items:center;border-radius:999px;background:#e6f1f8;color:#5c89aa;font-size:11px;font-weight:800}.archive-card{padding:14px;border-radius:18px;background:#fff;border:1px solid rgba(45,67,85,.07)}.archive-head{display:flex;justify-content:space-between;gap:10px}.archive-head b,.archive-head small{display:block}.archive-head small{margin-top:3px;color:#7d91a3;font-size:10px}.archive-head>span{max-width:42%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8396a7;font-size:9px}.archive-card p,.archive-supported{font-size:11px;line-height:1.55}.archive-supported{color:#557a65}.archive-actions{display:flex;justify-content:flex-end;gap:7px;margin-top:10px}.archive-actions button{border:0;border-radius:10px;background:#e8f2f9;color:#9c5572;padding:8px 10px;font-size:10px}.regex-quick-controls{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:10px;padding:9px 10px;border-radius:11px;background:#f5faff}.order-control{display:flex;align-items:center;gap:6px;color:#6d8498;font-size:10px}.order-control input{width:64px;border:1px solid #dce8ef;border-radius:8px;background:#fff;padding:5px 7px;color:#34536a}.regex-editor-backdrop{position:fixed;inset:0;z-index:80;display:flex;align-items:flex-end;justify-content:center;background:rgba(35,55,72,.28);backdrop-filter:blur(3px)}.regex-editor-sheet{width:min(100%,520px);max-height:88vh;overflow:auto;padding:18px;border-radius:24px 24px 0 0;background:#f7fafc;color:#344f64;box-shadow:0 -18px 45px rgba(35,55,72,.16)}.regex-editor-head{display:flex;align-items:flex-start;justify-content:space-between}.regex-editor-head small{color:#5f8fb2;font-size:9px;font-weight:800;letter-spacing:.08em}.regex-editor-head h2{margin:2px 0 0}.regex-editor-head button{width:34px;height:34px;border:0;border-radius:999px;background:#e8f1f6;color:#506a80;font-size:22px}.regex-editor-note{margin:10px 0 14px;padding:10px;border-radius:12px;background:#eef6fc;color:#6d8498;font-size:11px;line-height:1.6}.regex-editor-fields{display:grid;gap:10px}.regex-editor-fields>label,.regex-editor-grid label{display:grid;gap:5px;color:#34536a;font-size:11px;font-weight:800}.regex-editor-fields input,.regex-editor-fields textarea{width:100%;border:1px solid #dce8ef;border-radius:11px;background:#fff;padding:9px;color:#34536a;font:inherit;font-size:11px;box-sizing:border-box}.regex-editor-fields textarea{resize:vertical;line-height:1.5}.regex-editor-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.regex-editor-toggles{display:grid;grid-template-columns:1fr 1fr;gap:7px;padding:10px;border-radius:12px;background:#eef6fb}.regex-editor-toggles label{display:flex;align-items:center;gap:6px;color:#506a80;font-size:10px}.regex-editor-toggles input{width:auto;accent-color:#6daedc}.regex-editor-actions{display:grid;grid-template-columns:1fr 1.5fr;gap:8px;margin-top:14px}.regex-editor-actions button{border:0;border-radius:12px;background:#e8f1f6;color:#5d7d98;padding:11px;font-weight:800}.regex-editor-actions .primary{background:#6daedc;color:white}@media(max-width:390px){.tabs button{font-size:10px}.state-card dl{grid-template-columns:1fr}}

/* V0.4.5.1：资源库必须始终收在手机可视宽度内。 */
.world-center,.library,.archive-section,.archive-card,.report-card,.compat-card,.import-card,.resource-card,.resource-main,.resource-main>div,.archive-head,.archive-head>div,.section-head,.section-head>div{min-width:0;max-width:100%}
.world-center{width:100%;overflow-x:hidden}
.library,.archive-section{width:100%;overflow:hidden}
.archive-head{flex-wrap:wrap}
.archive-head>div{flex:1 1 220px}
.archive-head b,.archive-card p,.archive-supported,.report-card h3,.report-card p,.report-ok,.report-warning,.compat-card p,.compat-card li,.resource-main b,.resource-main small,.usage-line{overflow-wrap:anywhere;word-break:break-word}
.archive-head>span{flex:1 1 120px;max-width:100%;min-width:0;white-space:normal;overflow-wrap:anywhere;word-break:break-word}
.archive-card,.report-card,.compat-card,.resource-card,.import-card{overflow:hidden}
.archive-actions{flex-wrap:wrap}
.archive-actions button{min-width:0;flex:0 1 auto}
@media(max-width:430px){
  .world-center{padding-left:10px;padding-right:10px}
  .import-card{padding-left:14px;padding-right:14px}
  .archive-head{flex-direction:column;align-items:stretch}
  .archive-head>span{max-width:100%;white-space:normal;overflow-wrap:anywhere;word-break:break-word}
  .archive-actions{justify-content:stretch}
  .archive-actions button{flex:1 1 calc(33.333% - 6px)}
}
