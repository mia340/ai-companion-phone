...
export const COUPLE_BOARD_PROMPTS: CoupleBoardPrompt[] = [
  ...
  { id: 'd1-07', type: 'dare', intensity: 1, modes: ['reality'], theme: 'flirt', text: "靠近 {partner} 一点，用十个字以内说一句明显是在想 TA 的话。" },
  ...
  { id: 'd1-11', type: 'dare', intensity: 1, modes: BOTH_MODES, theme: 'memory', text: "说一件最近让你觉得“还好有 {partner}”的小事。" },
  ...
  { id: 'd2-02', type: 'dare', intensity: 2, modes: ['reality'], theme: 'flirt', text: "看着 {partner} 说一句“你再这样我就____了”，空格自己填。" },
  ...
  { id: 'd2-06', type: 'dare', intensity: 2, modes: ['reality'], theme: 'flirt', text: "装作很随意地问 {partner} 一句，其实明显是在想再靠近一点的话。" },
  ...
  { id: 'd2-10', type: 'dare', intensity: 2, modes: ['reality'], theme: 'flirt', text: "贴近一点，对 {partner} 说“今晚给你一个特权：____”。" },
  ...
  { id: 'd3-03', type: 'dare', intensity: 3, modes: ['reality'], theme: 'flirt', text: "看着就在你旁边的 {partner}，直接说“我现在最想先____。”" },
  ...
  { id: 'd3-10', type: 'dare', intensity: 3, modes: ['reality'], theme: 'flirt', text: "不用玩笑也不用暗示，直接对 {partner} 说一句 TA 一听就懂的暧昧话。" },
  ...
  { id: 'd4-03', type: 'dare', intensity: 4, modes: ['reality'], theme: 'adult', adultOnly: true, text: "贴近 {partner}，说一句成年人一听就懂的暧昧话，别用玩笑糊弄过去。" },
  ...
  { id: 'd4-10', type: 'dare', intensity: 4, modes: ['reality'], theme: 'adult', adultOnly: true, text: "看着 {partner} 说：“你就在我旁边，我今晚大概不会只想抱你。”" },
  { id: 'd4-11', type: 'dare', intensity: 4, modes: ['reality'], theme: 'chemistry', adultOnly: true, text: "让 {partner} 从嘴、颈侧、耳边三个位置里选一个，你亲一下。" },
  { id: 'd4-12', type: 'dare', intensity: 4, modes: ['reality'], theme: 'adult', adultOnly: true, text: "说一个你希望 {partner} 在性爱里多做一点的事，再说一个你自己不想碰的点。" },
  ...
  { id: 'd4-16', type: 'dare', intensity: 4, modes: ['reality'], theme: 'adult', adultOnly: true, text: "如果都愿意，抱着 {partner} 接一个慢一点的吻；停下后由你先说一句“我还想继续____”。" },
  ...
  { id: 'd5-04', type: 'dare', intensity: 5, modes: BOTH_MODES, theme: 'private', adultOnly: true, text: "说一个“我在床上其实很吃这一套”的偏好，越具体越好，但不用现场做。" },
  { id: 'd5-05', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "从背后抱住 {partner}，搂着腰，在耳边说一句“今晚我想你怎么对我”。" },
  { id: 'd5-06', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "从“更温柔 / 更主动 / 更慢一点 / 更大胆一点”里选一个，直接告诉 {partner} 你今晚更想要哪种。" },
  { id: 'd5-07', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "如果都愿意，让 {partner} 选嘴、颈侧或锁骨附近，你亲一下。" },
  { id: 'd5-08', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "贴近 {partner} 耳边，说一句你深夜真的可能对 TA 说的成人暧昧话，别说得像文案。" },
  { id: 'd5-09', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "把手放在 {partner} 的腰或背上，把 TA 轻轻拉近，保持十秒。" },
  { id: 'd5-10', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "说一个你想和 {partner} 尝试的情趣，并给它标成“现在就能聊 / 以后再聊 / 没兴趣”里的一个。" },
  ...
  { id: 'd5-14', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "说一个对你来说床上“绝对加分”的点，再说一个会让你马上没感觉的点。" },
  { id: 'd5-15', type: 'dare', intensity: 5, modes: ['reality'], theme: 'private', adultOnly: true, text: "如果都愿意，关掉屏幕，抱着接吻十五秒；结束后由你先用一个词形容刚才的感觉。" },
