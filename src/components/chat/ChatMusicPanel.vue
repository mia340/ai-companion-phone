...
<style scoped>
.bottom-panel{width:100%;max-height:88%;overflow-y:auto;padding:8px 18px max(24px,env(safe-area-inset-bottom));border-radius:26px 26px 0 0;background:#f8fcff;box-shadow:0 -18px 50px rgba(70,42,55,.18);transition:transform .24s cubic-bezier(.22,.8,.24,1);will-change:transform}.panel-handle{position:relative;width:84px;height:17px;margin:-3px auto 15px;background:transparent;touch-action:none}.panel-handle:after{content:'';position:absolute;top:5px;left:50%;width:42px;height:5px;transform:translateX(-50%);border-radius:999px;background:#c8dbe9}.panel-title-row{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.panel-title-row h2{margin:2px 0 16px}.panel-title-row small{color:#70879b}.panel-title-row>button{width:36px;height:36px;border:0;border-radius:50%;background:#eaf3fa;color:#506a80;font-size:22px}.music-cover{width:104px;height:104px;display:grid;place-items:center;margin:0 auto 18px;border-radius:27px;background:linear-gradient(145deg,#ddecf9,#a9cfea);color:#fff;font-size:48px;box-shadow:0 16px 28px rgba(203,98,143,.22)}label{display:flex;flex-direction:column;gap:5px;margin:11px 0;font-size:12px;font-weight:700}label input{padding:11px 12px;border:1px solid rgba(80,50,62,.1);border-radius:13px;background:#fff}.local-file-button{align-items:center;padding:11px;border-radius:13px;background:#eaf3fa;color:#5f7c95;text-align:center;cursor:pointer}.local-file-button input{display:none}.music-progress-row{display:grid;grid-template-columns:38px 1fr 38px;align-items:center;gap:7px;margin-top:14px;font-size:11px;color:#6e8497}.music-progress-row input{width:100%}.music-controls{display:flex;align-items:center;justify-content:center;gap:14px;margin:16px 0}.music-play{width:54px;height:54px;border:0;border-radius:50%;background:#79add8;color:#fff;font-size:21px}.music-react{padding:12px 17px;border:0;border-radius:15px;background:#e7f2fa;color:#506a80;font-weight:700}.music-react:disabled{opacity:.55}.panel-footnote{color:#748b9e;font-size:12px;line-height:1.65}
</style>
