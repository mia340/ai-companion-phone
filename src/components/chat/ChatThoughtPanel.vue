...
<style scoped>
.bottom-panel{width:100%;max-height:88%;overflow-y:auto;padding:8px 18px max(24px,env(safe-area-inset-bottom));border-radius:26px 26px 0 0;background:#f8fcff;box-shadow:0 -18px 50px rgba(70,42,55,.18);transition:transform .24s cubic-bezier(.22,.8,.24,1);will-change:transform}.panel-handle{position:relative;width:84px;height:17px;margin:-3px auto 15px;background:transparent;touch-action:none;cursor:grab}.panel-handle:after{content:'';position:absolute;top:5px;left:50%;width:42px;height:5px;transform:translateX(-50%);border-radius:999px;background:#c8dbe9}.panel-title-row{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.panel-title-row h2{margin:2px 0 16px}.panel-title-row small{color:#70879b}.panel-title-row>button{width:36px;height:36px;border:0;border-radius:50%;background:#eaf3fa;color:#506a80;font-size:22px}.thought-person{display:flex;align-items:center;gap:14px;padding:13px;border-radius:20px;background:linear-gradient(135deg,#fff,#eaf5fd)}.thought-person p{margin:5px 0 0;color:#6f879c}blockquote{margin:18px 0;padding:18px;border:0;border-radius:19px;background:#edf5fb;color:#654b57;line-height:1.85}.panel-primary{width:100%;padding:12px 14px;border:0;border-radius:15px;background:#79add8;color:#fff;font-weight:700}.panel-primary:disabled{opacity:.55}.panel-empty{padding:28px 8px;color:#748b9e;font-size:12px;line-height:1.65;text-align:center}
.status-chips{display:flex;flex-wrap:wrap;gap:7px;margin:12px 0 0}.status-chips span{border-radius:999px;background:#e8f2f9;color:#8b6576;padding:7px 10px;font-size:11px}
.empty-thought{font-style:normal;color:#a28793}.state-lists{display:grid;gap:8px;margin:0 0 14px}.state-lists p{display:grid;gap:5px;margin:0;padding:11px 12px;border-radius:14px;background:#f2f8fc}.state-lists b{color:#9a6079;font-size:11px}.state-lists span{color:#765b67;font-size:12px}
</style>
