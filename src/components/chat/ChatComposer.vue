...
<style scoped>
.image-processing-bar,.pending-images-bar,.reply-preview-bar,.recording-bar,.next-message-hint{flex:0 0 auto;border-top:1px solid rgba(35,65,88,.055);background:rgba(255,255,255,.97)}
.image-processing-bar{display:grid;gap:7px;padding:9px 12px}.image-processing-bar>div{display:flex;justify-content:space-between;gap:10px}.image-processing-bar b{color:#5f91b8;font-size:12px}.image-processing-bar span{max-width:62%;overflow:hidden;color:#7d8f9f;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.image-processing-bar progress{width:100%;height:5px;accent-color:#6da8d3}
.pending-images-bar{padding:8px 12px}.pending-images-summary{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:7px}.pending-images-summary>div{display:grid;gap:2px}.pending-images-summary b{color:#5f91b8;font-size:12px}.pending-images-summary span{color:#7d8f9f;font-size:11px}.pending-images-summary button{border:0;background:transparent;color:#5d88aa;font-size:12px}.pending-images-grid{display:flex;gap:7px;overflow-x:auto;padding:3px 2px 5px;scrollbar-width:none}.pending-images-grid::-webkit-scrollbar{display:none}.pending-images-grid figure{position:relative;width:58px;height:58px;flex:0 0 auto;margin:0;border-radius:13px;outline:2px solid transparent;outline-offset:1px}.pending-images-grid figure.selected{outline-color:#6da8d3}.pending-image-preview-button{width:100%;height:100%;padding:0;border:0;background:transparent}.pending-images-grid img{width:100%;height:100%;object-fit:cover;border-radius:12px}.pending-images-grid .pending-image-remove-button{position:absolute;top:-5px;right:-5px;width:21px;height:21px;padding:0;border:2px solid #fff;border-radius:50%;background:#536b7d;color:#fff;line-height:17px}.pending-images-grid figure small{position:absolute;left:4px;bottom:4px;min-width:18px;padding:1px 4px;border-radius:999px;background:rgba(30,45,58,.64);color:#fff;font-size:9px;text-align:center}
