...
.image-processing-bar{display:grid;gap:7px;padding:9px 12px}.image-processing-bar>div{display:flex;justify-content:space-between;gap:10px}.image-processing-bar b{color:#ba5e86;font-size:12px}.image-processing-bar span{max-width:62%;overflow:hidden;color:#8c717c;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.image-processing-bar progress{width:100%;height:5px;accent-color:#d96b99}
.pending-images-bar{padding:8px 12px}.pending-images-summary{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:7px}.pending-images-summary>div{display:grid;gap:2px}.pending-images-summary b{color:#ba5e86;font-size:12px}.pending-images-summary span{color:#8c717c;font-size:11px}.pending-images-summary button{border:0;background:transparent;color:#b25d80;font-size:12px}.pending-images-grid{display:flex;gap:7px;overflow-x:auto;padding:3px 2px 5px;scrollbar-width:none}.pending-images-grid::-webkit-scrollbar{display:none}.pending-images-grid figure{position:relative;width:58px;height:58px;flex:0 0 auto;margin:0;border-radius:13px;outline:2px solid transparent;outline-offset:1px}.pending-images-grid figure.selected{outline-color:#d96b99}.pending-image-preview-button{width:100%;height:100%;padding:0;border:0;background:transparent}.pending-images-grid img{width:100%;height:100%;object-fit:cover;border-radius:12px}.pending-images-grid .pending-image-remove-button{position:absolute;top:-5px;right:-5px;width:21px;height:21px;padding:0;border:2px solid #fff;border-radius:50%;background:#705762;color:#fff;line-height:17px}.pending-images-grid figure small{position:absolute;left:4px;bottom:4px;min-width:18px;padding:1px 4px;border-radius:999px;background:rgba(45,28,36,.62);color:#fff;font-size:9px;text-align:center}
.selected-image-detail{display:flex;align-items:center;justify-content:space-between;gap:9px;margin-top:4px;padding:8px;border-radius:12px;background:#faf4f7}.selected-image-detail__text{min-width:0;display:grid;gap:2px}.selected-image-detail__text b{overflow:hidden;color:#6d4d5a;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.selected-image-detail__text span,.selected-image-detail__text small{color:#987986;font-size:10px}.selected-image-detail__actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:4px}.selected-image-detail__actions button,.failed-image-actions button{padding:5px 7px;border:0;border-radius:8px;background:#f0dfe7;color:#9d5574;font-size:10px}.selected-image-detail__actions button:disabled,.failed-image-actions button:disabled{opacity:.4}
.failed-image-hint{margin:7px 0 0;color:#a45b6c;font-size:10px}.failed-image-list{display:grid;gap:6px;margin-top:7px}.failed-image-list article{display:grid;gap:6px;padding:8px;border:1px solid rgba(197,78,99,.18);border-radius:12px;background:#fff7f8}.failed-image-list article>div:first-child{min-width:0;display:grid;gap:2px}.failed-image-list b{overflow:hidden;color:#a24458;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.failed-image-list span{color:#8e5f69;font-size:10px;line-height:1.35}.failed-image-list small{color:#ad8991;font-size:9px}.failed-image-actions{display:flex;gap:5px}.failed-image-list details{color:#9d7881;font-size:9px}.failed-image-list summary{cursor:pointer}.failed-image-list p{margin:4px 0 0;line-height:1.4}
.reply-preview-bar,.recording-bar{display:flex;align-items:center;gap:10px;padding:8px 12px 7px}.reply-preview-bar>div,.recording-bar>div{min-width:0;flex:1}.recording-bar>div{display:grid;gap:3px}.reply-preview-bar b,.recording-bar b{color:#ba5e86;font-size:12px}.reply-preview-bar span,.recording-bar small{overflow:hidden;color:#8c717c;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.reply-preview-bar>button{width:30px;height:30px;flex:0 0 auto;border:0;border-radius:50%;background:#f4e9ed;color:#785d69;font-size:19px}.reply-preview-bar>div{display:flex;flex-direction:column;gap:2px;padding-left:9px;border-left:3px solid #da729f}.recording-bar>button{padding:7px 11px;border:0;border-radius:12px;background:#f3e7ec;color:#8b5f70}.recording-dot{width:10px;height:10px;flex:0 0 auto;border-radius:50%;background:#df5e79;animation:recording-pulse 1s ease-in-out infinite}.next-message-hint{padding:6px 14px;color:#9a7383;font-size:11px;text-align:center}
