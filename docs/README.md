...
当前开发线：**V0.5.0-alpha.5.1.21**

```text
应用：0.5.0-alpha.5.1.21
IndexedDB：V18
Backup：V12
测试定义：41 个测试文件 / 345 个 it/test 声明
当前 UI 主线：Launcher Grid V12（4×6 网格 / insert+reflow / App 文件夹 / 幽灵页强制恢复槽 / 真机边缘翻页 / 固定 Dock）+ 玩家自定义 Widget
```
...
3. `releases/V0.5.0-alpha.5.1.21_部署与更新.md`：当前版本的专项验收步骤。
