...
当前开发线：**V0.5.0-alpha.5.1.27**

```text
应用：0.5.0-alpha.5.1.27
IndexedDB：V18
Backup：V12
测试定义：43 个测试文件 / 366 个 it/test 声明
当前 UI 主线：Launcher Grid V13（4×6 网格 / insert+reflow / App 文件夹 / Inspector V4 / Dock-Home 去重 / 真机边缘翻页 / 固定 Dock）+ 玩家自定义 Widget
```
...
3. `releases/V0.5.0-alpha.5.1.27_部署与更新.md`：当前版本的专项验收步骤。
