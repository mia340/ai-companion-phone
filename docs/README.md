...
当前开发线：**V0.5.0-alpha.5.1.10**

```text
应用：0.5.0-alpha.5.1.10
IndexedDB：V18
Backup：V12
测试定义：38 个测试文件 / 317 个 it/test 声明
当前 UI 主线：Launcher V4（手势翻页 / 内容驱动页数 / 自动收空页 / 固定 Dock）+ 玩家自定义 Widget
```
...
3. `releases/V0.5.0-alpha.5.1.10_部署与更新.md`：当前版本的专项验收步骤。
